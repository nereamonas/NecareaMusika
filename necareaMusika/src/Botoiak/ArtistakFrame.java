...
public class ArtistakFrame extends JFrame {
	...
	public static void main(String[] args,String erabiltzailea, String p) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ArtistakFrame frame = new ArtistakFrame(erabiltzailea, p);
	 ...
	 * @throws SQLException 
	 */
	public ArtistakFrame(String erabiltzailea, String p) throws SQLException {
		...
		JLabel lblGordetaDituzunAbestiak = new JLabel("Artista guztiak");
						...
						.addGroup(gl_panel_1.createSequentialGroup()
							...
							.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel_1.createSequentialGroup()
									...
									.addComponent(btnArtistaJarraituNahi))
								.addGroup(gl_panel_1.createSequentialGroup()
									.addGap(31)
									.addComponent(btnArtistanSartu)))
							.addGap(12))
		...
		Vector elem=necarea.artistaGuztiak();
		...
		//artistaJarraitu
		btnArtistaJarraituNahi.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(list.getSelectedIndex()!=-1) {
					necarea.artistaGorde(erabiltzailea,(String) list.getSelectedValue());
				}
			}
		});
	}
