...
public class AbestiakFrame extends JFrame {
	...
	public static void main(String[] args,String erabiltzailea, String p) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AbestiakFrame frame = new AbestiakFrame(erabiltzailea, p);
	 ...
	 * @throws SQLException 
	 */
	public AbestiakFrame(String erabiltzailea, String p) throws SQLException {
		...
		JLabel lblGordetaDituzunAbestiak = new JLabel("Eskura dauden abesti guztiak");
		...
		JButton btnAbestiaGorde = new JButton("Abestia gorde");
