...
public class PasahitzaAldatuFrame extends JFrame {
	...
	public static void main(String[] args, String erabiltzailea, String p) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PasahitzaAldatuFrame frame = new PasahitzaAldatuFrame(erabiltzailea,p);
	 ...
	 * @throws SQLException 
	 */
	public PasahitzaAldatuFrame(String erabiltzailea, String p) throws SQLException {
				...
				if (!p.contentEquals(pp)) {
					...
					String p2=textField_2.getText();
							...
							if(p1.contentEquals(p2)) {
								necarea.pasahitzaAldatu(erabiltzailea,p1);
		...
		btnEzDutPasahitza.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				NireInformazioaFrame infor=null;
				try {
					infor = new NireInformazioaFrame(erabiltzailea,p);
