...
public class GordeErabiltzaileFrame extends JFrame {
	...
	public static void main(String[] args,String erabiltzailea, String p) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GordeErabiltzaileFrame frame = new GordeErabiltzaileFrame(erabiltzailea, p);
	 ...
	 * @throws SQLException 
	 */
	public GordeErabiltzaileFrame(String erabiltzailea, String p) throws SQLException {
		...
		JLabel lblGordetaDituzunAbestiak = new JLabel("Jarraitzen dituzun erabiltzaileak");
