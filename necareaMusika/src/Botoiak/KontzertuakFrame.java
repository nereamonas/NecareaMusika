...
public class KontzertuakFrame extends JFrame {
	...
	public static void main(String[] args,String erabiltzailea, String p) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					KontzertuakFrame frame = new KontzertuakFrame(erabiltzailea, p);
	 ...
	 * @throws SQLException 
	 */
	public KontzertuakFrame(String erabiltzailea, String p) throws SQLException {
		...
		JLabel lblGordetaDituzunAbestiak = new JLabel("Emango diren kontzertuak");
		...
		Vector elem=necarea.kontzertuGuztiak();
