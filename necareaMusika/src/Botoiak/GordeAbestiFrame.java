...
public class GordeAbestiFrame extends JFrame {
	...
	public static void main(String[] args,String erabiltzailea, String p) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GordeAbestiFrame frame = new GordeAbestiFrame(erabiltzailea, p);
	 ...
	 * @throws SQLException 
	 */
	public GordeAbestiFrame(String erabiltzailea, String p) throws SQLException {
		...
		JLabel lblGordetaDituzunAbestiak = new JLabel("Gordeta dituzun abestiak");
		...
		Vector elem=necarea.gordeDituenAbestiGuztiak(erabiltzailea);
