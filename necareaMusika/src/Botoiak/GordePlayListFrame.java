...
public class GordePlayListFrame extends JFrame {
	...
	public static void main(String[] args,String erabiltzailea, String p) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GordePlayListFrame frame = new GordePlayListFrame(erabiltzailea, p);
	 ...
	 * @throws SQLException 
	 */
	public GordePlayListFrame(String erabiltzailea, String p) throws SQLException {
		...
		JLabel lblGordetaDituzunAbestiak = new JLabel("Gordeta dituzun Playlist-ak");
