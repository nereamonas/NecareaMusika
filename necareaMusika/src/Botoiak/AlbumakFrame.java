...
public class AlbumakFrame extends JFrame {
	...
	public static void main(String[] args,String erabiltzailea, String p) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AlbumakFrame frame = new AlbumakFrame(erabiltzailea, p);
	 ...
	 * @throws SQLException 
	 */
	public AlbumakFrame(String erabiltzailea, String p) throws SQLException {
		...
		JLabel lblGordetaDituzunAbestiak = new JLabel("Eskura dauden album guztiak");
