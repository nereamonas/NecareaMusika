...
public class GordeArtistaFrame extends JFrame {
	...
	public static void main(String[] args,String erabiltzailea, String p) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GordeArtistaFrame frame = new GordeArtistaFrame(erabiltzailea, p);
	 ...
	 * @throws SQLException 
	 */
	public GordeArtistaFrame(String erabiltzailea, String p) throws SQLException {
		...
		JLabel lblGordetaDituzunAbestiak = new JLabel("Jarraitzen dituzun artistak");
